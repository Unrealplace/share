...
-(instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        UIButton * btn3 = [self btnAnimateWithFrame:CGRectMake(LSCREENW/4-90, LSCREENH- 50, 60, 60) imageName:@"img_wechat_logo" animateFrame:CGRectMake(LSCREENW/4-90, LSCREENH-80, 60, 60) delay:0.0];
        btn3.tag=1;
        ...
        UIButton * btn4 = [self btnAnimateWithFrame:CGRectMake((LSCREENW/4)*3-30, LSCREENH- 50, 60, 60) imageName:@"img_wechat_friend" animateFrame:CGRectMake((LSCREENW/4)*3 + 30, LSCREENH-80, 60, 60) delay:0.1];
        btn4.tag=2;
